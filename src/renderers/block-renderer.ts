// The shared contract both rendering strategies (raymarch, triangle) implement.
// A `RendererSwitch` owns one of each and routes calls per block/frame — see
// `renderer-switch.ts`. `applyLighting` is called on both renderers every
