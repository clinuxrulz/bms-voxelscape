...
export function Joystick(params: {
  ...
  let hitAreaSize = createSignal(
    typeof params.hitAreaSize === "function"
      ? params.hitAreaSize()
      : params.hitAreaSize,
  );
  ...
  createEffect(
    () =>
      typeof params.hitAreaSize === "function"
        ? (params.hitAreaSize as Accessor<number>)()
        : (params.hitAreaSize as number),
    (h) => {
      hitAreaSize[1](h);
    },
  );
  createEffect(
    () => params.outerRingSize(),
    (o) => {
      outerRingSize[1](o);
    },
  );
  ...
  let value = createMemo(() => {
    ...
    return new THREE.Vector2()
      .copy(dragOffset2)
      .multiplyScalar(1.0 / outerRingSize[0]());
  });
      ...
      >
        ...
        >
          <div
            style={{
              position: "absolute",
              left: `calc(50% + ${dragOffset2()?.x ?? 0.0}px)`,
              top: `calc(50% + ${dragOffset2()?.y ?? 0.0}px)`,
              transform: "translate(-50%,-50%)",
              width: `${knobSize[0]()}px`,
